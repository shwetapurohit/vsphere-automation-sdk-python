...
class DeleteProtectionGroupSnapshots(object):
    ...
    def run(self):
        ...
        pgs_info = self.ssClient.clusters.ProtectionGroups.list(clusterId)
        pgId = 0
        ...
        snapshots_info = self.ssClient.clusters.protection_groups\
        ...
        for time in timeToDel:
            ...
            task = self.ssClient.clusters.protection_groups\
